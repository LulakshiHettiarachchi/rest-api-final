...
const studnet_route = require("./routes/student_routes");
//const todos_route = require("./routes/todos_routes");
const errorHandler = require('./utils/errorHandler');
//const student_auth = require("./services/auth");
...
app.use("/api/student" ,studnet_route);
//app.use("/api/todos" , student_auth,  todos_route);
